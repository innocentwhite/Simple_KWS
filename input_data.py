...
class GSCDataset(Dataset):
    def __init__(self, data_url, data_dir, silence_percentage, unknown_percentage,
                 ...
                 model_settings, sess, model_architecture, mode="training", transform=None, background_frequency=None,
                 background_volume_range=None, time_shift=None):
        ...
        if self.mode == "training":
            self.data, self.labels = self.get_data(-1, 0, model_settings, background_frequency,
                                                   background_volume_range, time_shift, mode, sess)

        else:
            self.data, self.labels = self.get_data(-1, 0, model_settings, 0.0,
                                                   0.0, 0, mode, sess)
    ...
    def __len__(self):
        return len(self.data_index[self.mode])
